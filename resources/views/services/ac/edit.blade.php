...
@section('content')
    <form action="{{ url('transaksi-detail/update/'.$transaksi_detail->id) }}" method="POST" style="padding-bottom: 5rem" enctype="multipart/form-data">
        @csrf
